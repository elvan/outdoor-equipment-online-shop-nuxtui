    ...
    reviews: [
      {
        ...
        rating: 5,
        title: 'Tas carrier terbaik untuk pendakian!',
        comment: 'Sudah pakai tas ini untuk mendaki Semeru dan Rinjani. Kualitas bahan sangat bagus, tahan air, dan sangat nyaman di punggung. Rain cover-nya juga berfungsi dengan baik saat hujan deras. Highly recommended!',
      ...
      },
      {
        ...
        comment: 'Tas ini memang berkualitas tinggi, kompartemennya banyak dan tersusun rapi. Cuma agak berat ya untuk ukuran 60L, tapi overall puas dengan pembelian ini. Cocok untuk pendakian 2-3 hari.',
      ...
      },
      {
        ...
        comment: 'Awalnya ragu karena harganya lumayan, tapi setelah pakai ternyata sebanding dengan kualitasnya. Sistem back panel-nya ergonomis banget, jadi nggak sakit punggung meski bawa beban berat. Recommended banget!',
        date: '2024-07-28T09:45:00Z',
        verified: true,
        helpful: 18,
        images: []
      },
      {
        ...
        rating: 4,
        title: 'Kualitas oke, desain menarik',
        comment: 'Tas carrier yang bagus untuk cewek. Warna merah gunungnya cantik dan tidak terlalu mencolok. Kapasitas 60L pas untuk pendakian weekend. Sistem pengaturan tali pinggang juga mudah disesuaikan.',
        date: '2024-07-20T16:15:00Z',
        verified: true,
        helpful: 12,
        images: []
      }
    ...
    reviews: [
      {
        ...
        rating: 5,
        title: 'Tenda terbaik untuk solo camping!',
        comment: 'Tenda ini benar-benar ultralight tapi kuat! Sudah pakai untuk camping di Bromo dan Dieng, tahan angin kencang dan hujan. Setup-nya juga cepat, dalam 5 menit sudah bisa dipasang. Worth it banget!',
        date: '2024-08-20T08:15:00Z',
        verified: true,
        helpful: 31,
        images: []
      },
      {
        ...
        userName: 'Maya Sari',
        rating: 5,
        title: 'Perfect untuk couple camping',
        comment: 'Pas banget untuk kami berdua. Space-nya cukup luas untuk 2 orang + gear. Material flysheet-nya waterproof banget, kemarin kena hujan seharian di Kawah Putih tetap kering di dalam. Highly recommend!',
        date: '2024-08-12T19:30:00Z',
        verified: true,
        helpful: 25,
        images: []
      },
      {
        ...
        rating: 4,
        title: 'Kualitas bagus, agak susah setup pertama kali',
        comment: 'Tenda berkualitas tinggi dengan harga yang reasonable. Cuma pertama kali setup agak bingung, tapi setelah beberapa kali jadi lancar. Ventilasi-nya juga oke, nggak pengap di dalam.',
    ...
    reviews: [
      {
        ...
        rating: 4,
        title: 'Jaket yang nyaman untuk hiking',
        comment: 'Jaket softshell yang bagus untuk hiking di cuaca dingin. Breathable dan windproof-nya berfungsi dengan baik. Cuma agak tipis untuk extreme cold, lebih cocok untuk cuaca dingin biasa.',
        date: '2024-08-25T07:20:00Z',
        verified: true,
        helpful: 17,
        images: []
      },
      {
        ...
        rating: 5,
        title: 'Stylish dan fungsional!',
        comment: 'Jaket ini perfect banget! Bisa dipake untuk outdoor activity maupun daily wear di cuaca dingin. Cutting-nya pas untuk wanita, tidak terlalu boxy. Material-nya juga premium.',
        date: '2024-08-18T13:10:00Z',
        verified: true,
        helpful: 22,
        images: []
      },
      {
        id: 'rev-203',
        userId: 'user-203',
        userName: 'Dedi Susanto',
        rating: 5,
        title: 'Best softshell jacket!',
        comment: 'Sudah pakai untuk pendakian Merbabu dan Lawu. Jaket ini benar-benar windproof, nyaman dipakai untuk aktivitas outdoor. Sistem zipper-nya juga berkualitas tinggi. Definitely recommended!',
        date: '2024-08-05T09:40:00Z',
        verified: true,
        helpful: 28,
        images: []
      }
